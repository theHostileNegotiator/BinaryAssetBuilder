...
#if KANESWRATH
[StructLayout(LayoutKind.Sequential)]
public struct MetaGameUITacticalCommandSlots
{
    public BaseAssetType Base;
    public AssetReference<HotKeySlot> MGOpenObjectivesDialog;
    public AssetReference<HotKeySlot> MGOpenIntelligenceDialog;
    public AssetReference<HotKeySlot> MGEndTurn;
    public AssetReference<HotKeySlot> MGResupply;
    public AssetReference<HotKeySlot> MGClearOrders;
    public AssetReference<HotKeySlot> MGSell;
    public AssetReference<HotKeySlot> MGNextBase;
    public AssetReference<HotKeySlot> MGPrevBase;
    public AssetReference<HotKeySlot> MGNextStrikeForce;
    public AssetReference<HotKeySlot> MGPrevStrikeForce;
    public AssetReference<HotKeySlot> MGNextBattle;
}

[StructLayout(LayoutKind.Sequential)]
public struct MetaGameUICommonOpCommandSlots
{
    public BaseAssetType Base;
    public List<AssetReference<HotKeySlot>> Slot;
}
