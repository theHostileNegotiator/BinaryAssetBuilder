...
#if KANESWRATH
    public unsafe InGameUISimpleHelpTemplate* MgMove;
    public unsafe InGameUISimpleHelpTemplate* MgPatrol;
    public unsafe InGameUISimpleHelpTemplate* MgIntercept;
    public unsafe InGameUISimpleHelpTemplate* MgAirlift;
    public unsafe InGameUISimpleHelpTemplate* MgNavalMove;
    public unsafe InGameUISimpleHelpTemplate* PrevBase;
    public unsafe InGameUISimpleHelpTemplate* PrevStrikeForce;
    public unsafe InGameUISimpleHelpTemplate* NextStrikeForce;
    public unsafe InGameUISimpleHelpTemplate* NextBase;
#endif
}
